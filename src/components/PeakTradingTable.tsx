...
const STORAGE_KEY = 'cpq_peak_trading_rows';
...
export interface OverheadRates {
  ...
  workersComp: number;     // e.g. 2.5
  payrollTaxRate: number;  // e.g. 4.75 (0 if under threshold)
  pli: number;             // e.g. 2
}
...
export default function PeakTradingTable({
  onTotalChange,
  onProfitChange,
